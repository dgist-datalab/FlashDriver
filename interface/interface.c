...
#elif defined(pftl)
	mp.algo=&algo_pbase;
#elif defined(dftl) || defined(ctoc) || defined(dftl_test) || defined(ctoc_batch) || defined(sftl) || defined(tpftl) || defined(red_sftl) || defined(hash_sftl) || defined(red_tpftl) || defined(hash_tpftl)
	mp.algo=&__demand;
